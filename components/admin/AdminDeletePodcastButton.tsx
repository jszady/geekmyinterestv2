...
import { deletePodcastEpisodeAction } from "@/app/admin/podcast-actions";
import { useRouter } from "next/navigation";
import { useState, useTransition } from "react";

type Props = { episodeId: string; title: string };

export function AdminDeletePodcastButton({ episodeId, title }: Props) {
  ...
  return (
    <div className="rounded-xl border border-red-400/25 bg-red-500/[0.06] p-4">
      ...
      <p className="mt-2 text-sm text-zinc-400">
        Delete this podcast episode permanently.
      </p>
      {error ? (
