  ...
  return (
    <div className="flex flex-wrap items-center gap-4">
      ...
      <ul className="flex flex-wrap items-center gap-3" aria-label="Social links">
        <li>
          <a href="#" className={iconWrap} aria-label="Facebook">
            <svg
              className="h-4 w-4"
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <li>
          <a href="#" className={iconWrap} aria-label="X (Twitter)">
            <svg
              className="h-4 w-4"
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <li>
          <a href="#" className={iconWrap} aria-label="YouTube">
            <svg
              className="h-4 w-4"
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <li>
          <a href="#" className={iconWrap} aria-label="Discord">
            <svg
              className="h-4 w-4"
              viewBox="0 0 24 24"
              fill="currentColor"
